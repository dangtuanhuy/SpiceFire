    ...
    public class MenuItemController : Controller
    {
        ...
        public async Task<IActionResult> CreatePOST()
        {
            ...
            else
            {
                ...
                var uploads = Path.Combine(webRootPath, @"images\" + SD.DefaultFoodImg);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            MenuItemVM.MenuItem = await _db.MenuItem.Include("Category").Include("SubCategory").SingleOrDefaultAsync(m => m.Id == id);
