...
using SpiceFire.Utility;

namespace SpiceFire.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "Your Name can not null")]
            [Display(Name = "Your Name")]
            public string Name { get; set; }

            [Required(ErrorMessage = "StreetAddress can not null")]
            [Display(Name = "StreetAddress")]
            public string StreetAddress { get; set; }

            [Required(ErrorMessage = "PhoneNumber can not null")]
            [Display(Name = "PhoneNumber")]
            public string PhoneNumber { get; set; }

            [Required(ErrorMessage = "City can not null")]
            [Display(Name = "City")]
            public string City { get; set; }

            [Required(ErrorMessage = "State can not null")]
            [Display(Name = "State")]
            public string State { get; set; }

            [Required(ErrorMessage = "PostalCode can not null")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                // var user = new IdentityUser { Chúng ta sẽ dùng Appluication USer đã kế thừa từ Identity User
                var user = new ApplicationUser
                {
                    UserName = Input.Email,
                    Email = Input.Email,
                    //Các Propery có trong Aplication User
                    Name = Input.Name,
                    City = Input.City,
